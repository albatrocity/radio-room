...
export const bridgeRequestSchema = z.object({
  ...
  method: z.enum([
    ...
    /** List installed macOS `say` voices (ADR 0177). */
    "listSayVoices",
    /** Synthesize + queue TTS to configured CoreAudio device (ADR 0177). */
    "speak",
  ]),
...
/** Max code points for Media Bridge TTS / Burner Phone (ADR 0177). */
