...
export const SWEETWATER_SHOP: ItemShopsShopCatalogEntry = {
  ...
  name: "Sweetwater",
  openingMessage:
    "Hi! It's Chuck from {{shopName}}. We're having a big sale on pedals! Check us out in your shop tab.",
  availableItems: [
    { shortId: items.analogDelayPedal.shortId, coinValue: 30 },
    { shortId: items.compressorPedal.shortId, coinValue: 10 },
    { shortId: items.boostPedal.shortId, coinValue: 10 },
    { shortId: items.gate.shortId, coinValue: 15 },
    { shortId: items.jokerPedal.shortId, coinValue: 12 },
    { shortId: items.sampleHold.shortId, coinValue: 25 },
    { shortId: items.warranty.shortId, coinValue: 15 },
  ],
