import { ERROR_STATION_FETCH_FAILED, PUBSUB_RADIO_ERROR } from "../../lib/constants"
...
// TODO: Refactor this with lifecycle events
...
async function pubRadioError({ userId, roomId }: { userId: string; roomId: string }, error: Error) {
  pubClient.publish(PUBSUB_RADIO_ERROR, JSON.stringify({ userId, roomId, error }))
}
