...
/**
 * Renders the current user's Queue Theme assignment from
 * `UserGameStateContext.getPluginState(pluginName)` (`theme`, `isDecoy`).
 * No template props — same pattern as `bingo-card` (ADR 0097).
 */
