...
| `addScores(userId, changes, reason?)`                            | Same rules as `addScore` for each `{ attribute, amount }`, but one persist and one `GAME_STATE_CHANGED` for the batch. Returns new values in input order. Use when awarding coin and score together.                                                                                                                                                                                                                                                                                                                                                                                                 |
