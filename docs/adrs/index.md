...
| [0052](0052-global-artifacts-api.md) | Global artifacts API (`context.artifacts`) | Accepted. Extended by [0179](0179-reusable-multi-slot-password-stashes.md), [0184](0184-short-lived-stash-access-grants.md) |
...
| [0110](0110-catalog-mode-physical-media.md) | Catalog-mode Physical Media (albums + prefixed playlist toggles) | Partially superseded by [0111](0111-physical-media-rarity-signals.md) (rarity) and [0113](0113-cd-era-album-cd-lp-split.md) (CD-era format) |
...
| [0182](0182-stash-last-touched-at.md) | Stash `lastTouchedAt` stamped by the artifacts API | Accepted. Extended by [0184](0184-short-lived-stash-access-grants.md) |
