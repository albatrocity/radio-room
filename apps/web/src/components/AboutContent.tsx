...
function AboutContent({}: Props) {
  ...
  const creatorName = users.find((u) => u.userId === creator)?.username ?? creator
  return (
    <Box p="md" textStyle="body">
      ...
      <Text>
        If you're having fun with this, you can <Link href="/">create a room of your own</Link> and
        link your Spotify account to it.
      </Text>
      <Text as="p">
        As little data as possible is stored on our servers: learn more by reading the{" "}
