...
const NewsletterIssueIdRoute = NewsletterIssueIdRouteImport.update({
  id: '/$issueId',
  path: '/$issueId',
  getParentRoute: () => NewsletterRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/newsletter/$issueId': {
      id: '/newsletter/$issueId'
      path: '/$issueId'
      fullPath: '/newsletter/$issueId'
      preLoaderRoute: typeof NewsletterIssueIdRouteImport
      parentRoute: typeof NewsletterRoute
    }
    '/shows/$showId/publish': {
