...
| Media Bridge TTS (`requiresTarget: "spokenMessage"`) | Custom `use` + `api.speakOnMediaBridge`; consume only on success. See `items/burner-phone` / ADR 0177.                                                                                                                                                     |
